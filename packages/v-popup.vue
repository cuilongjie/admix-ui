...
export default {
    ...
    props: {
        ...
        toolbar: {              // 是否显示操作按钮。 Author by clj. on 2018.4.25
            type: Boolean,
            default: false
        },
        closeEnable: {          // 是否可以关闭当前组件的外部条件。 Author by clj. on 2018.4.25
            type: Boolean,
            default: true
        },
        modal: {
    ...
    watch: {
        currentValue (val) {
             ...
             *              -- Author by clj. on 2017.4.6
             * 修改了滚动条容器，以前是window滚动条，后因为需要在滚动条中fixed，所以改成了div容器滚动条。
             *              -- Author by clj. on 2017.5.16
             */
