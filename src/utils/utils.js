 ...
 *              -- Modified by clj. on 2016.10.20
 * ios下new Date(2016-10-31)报错:invalid date...要改为: 2016/10/31样式
 *              -- Modified by clj. on 2016.11.01
 * */
...
// 用户姓名格式验证：中文五个、英文30个、不能特殊字符、不能中英混排。 Author by clj. on 2018.5.9
